...
int main()
{
  ...
  numerical::adaptive_cav_simp_single adap_single(a,b,tol,h_min, f);
  //std::cout<< "The computation is finish: " << adap_single.finish_computation() <<std::endl;
  std::cout << "------- COMPUTING ---------" << std::endl << std::endl;

  real result = adap_single.solve();
